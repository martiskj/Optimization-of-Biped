function [init_trajectory, time] = calc_init_trajectory(x_init, N, tMax, parameters)
...
%     sampledTrajectory = sampledTrajectory';
    ...
    time = linspace(0, tMax, N);
    [~, odeSolution] = ode45(@(t,x) dynamics(x,t,parameters), time, x_init);
    init_trajectory = odeSolution';
end